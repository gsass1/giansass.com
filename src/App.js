        ...
        <main className='main'>
          ...
          <section ref={this.aboutMeSection} className='block block--centered block--aboutme' id='scroll-here'>
            <div className='block__container'>
              ...
              <p className='block__lead paragraph'>
                I have a <a href='https://giansass.com'>blog</a> where I write articles such as <a href='https://giansass.com/blog/mandelbrot-set-part-2-opengl-program/'>how to render the Mandelbrot set in OpenGL</a> and other interesting stuff.
              </p>
            </div>
          </section>
